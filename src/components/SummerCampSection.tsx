        ...
        >
          ...
          <div className="grid grid-cols-2 gap-3">
            <motion.div
              ...
              className="col-span-2 rounded-2xl overflow-hidden h-48"
            >
            ...
            <motion.div
              ...
              className="rounded-2xl overflow-hidden h-36"
            >
              <img src={scienceImg} alt="Children doing science experiments" className="w-full h-full object-cover" loading="lazy" />
            </motion.div>
          </div>
          ...
          <div className="bg-card rounded-3xl border border-border p-8 md:p-10 space-y-4">
            ...
            <Link
              to="/summer-camp"
              className="inline-flex items-center gap-2 mt-4 px-6 py-3 rounded-full bg-primary text-primary-foreground font-medium hover:shadow-md transition-all"
            >
