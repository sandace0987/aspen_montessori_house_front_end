      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10">
          ...
          <motion.div
            ...
            whileInView={{ opacity: 1, y: 0 }}
            viewport={{ once: true, amount: 0.3 }}
            transition={{ type: "spring" as const, duration: 0.8, delay: 0.1 }}
          >
            <ContactForm />
          </motion.div>
        </div>
    ...
    <form className="bg-card rounded-3xl p-8 shadow-card space-y-5" onSubmit={handleSubmit}>
      ...
      <div>
        ...
        <textarea
          ...
          maxLength={1000}
          className="w-full px-4 py-3 rounded-xl bg-muted border-0 text-sm focus:ring-2 focus:ring-ring focus:ring-offset-2 focus:ring-offset-background outline-none transition-all resize-none"
